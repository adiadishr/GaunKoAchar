...
if (isset($login)) {
    ...
    $que = mysqli_query($conn, "SELECT * FROM admin WHERE admin_username ='$user' AND admin_password ='$pass'");
...
<head>
    <title>GaunkoAchar | Admin Login</title>
    ...
    <title>GaunkoAchar | Log In</title>
</head>
...
<body>
    ...
    <div class="container" style="flex-direction: column">
        ...
        <img src="../img/gaunkoachar.png" style="width: 300px; justify-content:center;">
            ...
            <form method="POST" class="mt-2">
                <fieldset>
                    <div class="form-group">
                        ...
                        <span class="text-danger">*</span></b> <input class="form-control mb-2 border-secondary" name="admin_username"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="password" class="form-control border-secondary mb-2" name="admin_password" id="password"
