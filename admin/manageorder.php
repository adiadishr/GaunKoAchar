...
<head>
    ...
    <title>GaunKoAchar | Manage Order</title>
                ...
                ?>
                    <script>
                        function DeleteOrder(oid) {
                            if (confirm("Do you want to delete this order?")) {
                                ...
                                window.location.href = "deleteorder.php?oid=" + oid;
                            }
                        }
                    </script>
                    <b class="hov font">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        ?>
                            ...
                            <td><a href="javascript:DeleteOrder('<?php echo $row['oid']; ?>')" class="btn btn-danger">Delete</a></td>
                        <?php
                            echo "</tr>";
                            $i++;
                        }
