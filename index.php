			...
			<div class="row g-4 align-items-center">
				...
				<div class="col-lg-6">
					<div class="py-4">
						...
						<?php if (isset($_SESSION['email'])) {
							echo '<a href="./shop.php" class="banner-btn btn border-2 border-white rounded-pill text-dark py-3 px-5">Shop Now</a>';
						} else {
							echo '<a href="./login.php" class="banner-btn btn border-2 border-white rounded-pill text-dark py-3 px-5">Shop Now</a>';
						} ?>
					</div>
				</div>
