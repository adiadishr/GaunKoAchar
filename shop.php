                    ...
                    <div class="row g-4">
                        <div class="col-xl-5">
                            <div class="input-group w-100 mx-auto d-flex">
                                <input type="search" class="form-control p-3" placeholder="Search Items"
                                    aria-describedby="search-icon-1">
                                <button id="btn-search" class="border-1 input-group-text py-3 px-4"><span
                                        id="search-icon-1"><i class="fa fa-search"></i></span></button>
                            </div>
                        </div>
                        <div class="col-4"></div>
                        <div class="col-xl-3">
